export const IPC_CHANNELS = {
  ...
  WINDOW_GET_MAXIMIZE_STATE: "window:get-maximize-state",
  WINDOW_RESTORE_AFTER_SESSION: "window:restore-after-session",
  ...
  NATIVE_MOUSE_GRAB: "input:native-mouse-grab",
  NATIVE_MOUSE_RELEASE: "input:native-mouse-release",
  NATIVE_MOUSE_EVENT: "input:native-mouse-event",
