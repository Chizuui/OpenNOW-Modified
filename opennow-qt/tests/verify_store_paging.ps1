...
try {
    $hello = Request-Catalog 'core.hello' @{protocolVersion=4;shell='qt';shellVersion='0.5.4'}
    ...
    $alive = Request-Catalog 'core.hello' @{protocolVersion=4;shell='qt';shellVersion='0.5.4'}
