/**
 * GStreamer Android helper class.
 *
 * Copied from the GStreamer Android SDK:
 *   /home/chizui/gstreamer-sdk/arm64/share/gst-android/ndk-build/GStreamer.java
 *
 * Call GStreamer.init(context) once before gst_init() runs to provide the
 * native side with a Java VM pointer and application context, which are
 * required by the androidmedia plugin (gstandroidmedia) so it can
 * enumerate and instantiate hardware MediaCodec decoders.
 */
